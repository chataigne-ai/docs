...
- **Paiement mixte** : Possible mais pas utilisé
...
5. **Synchroniser les horaires** : Les expected times sont critiques pour la coordination (ils sont gérer en interne et exposer au POS)
