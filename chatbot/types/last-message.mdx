...
| `location`    | [Geopoint](#geopoint)                                    | Location sent by the customer as a geopoint. Present if type is `"location"` |
| `buttonReply` | [Button Reply](#button-reply)                            | Button reply data. Present if type is `"button_reply"`                       |
| `flowData`    | [Flow Data](#flow-data)                                  | Data of the form confirmed by the customer. Present if type is `"form"`      |
