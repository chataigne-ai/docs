...
| address                | [Address](/chatbot/types/common/address)               | Address of the location                                                                  |
...
| catalog                | [Catalog](/chatbot/types/location/catalog)             | Catalog of the location                                                                  |
...
| acceptanceSettings     | [Acceptance Settings](#acceptance-settings) (optional) | Settings for order acceptance                                                            |
...
| deliveryFee        | [Price](/chatbot/types/common/price) |         |
...
| Field                | Type                                | Description                                   |
| -------------------- | ----------------------------------- | --------------------------------------------- |
| mode                 | [Acceptance Mode](#acceptance-mode) | The current acceptance mode for the location. |
