...
| `status`          | [#order-status](./#order-status "mention")              | The current status of the order                                                                       |
...
| `deliveryAddress` | [address.md](../common/address.md "mention") (optional) | Address to which the customer wants this order to be delivered                                        |
| `total`           | [price.md](../common/price.md "mention")                | Order total price (With charges, discounts, etc...)                                                   |
| `items`           | [order-items.md](order-items.md "mention")              | Items in the order                                                                                    |
| `delivery`        | [delivery.md](delivery.md "mention") (optional)         | Information on the delivery if it exists                                                             |
| `payment`         | [payment.mdx](payment.mdx "mention") (optional)         | Payment information for the order                                                                     |
